          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl h-[360px] sm:h-[480px] md:h-[620px] w-full bg-charcoal group border border-black/10">
                ...
                {/* Overlay Quote Box - Hidden on Mobile */}
                <div className="hidden md:block absolute bottom-6 left-6 right-6 bg-charcoal/90 backdrop-blur-md p-6 rounded-2xl border border-white/15 shadow-2xl">
                  <p className="font-serif italic text-[15px] sm:text-[15px] md:text-[17px] text-white/90 leading-relaxed font-light mb-3">
            ...
            <div className="lg:col-span-7 space-y-8">
              <div className="space-y-4">
                <span className="font-sans text-[11px] sm:text-[15px] font-medium text-accent-gold uppercase tracking-[0.24em] flex items-center gap-2">
              ...
              <div className="space-y-5 font-sans text-[15px] sm:text-[17px] text-grey leading-relaxed font-light">
                <p>
                  Founded in the heart of Nagpur,{" "}
                  <strong className="text-charcoal font-medium">
                    Aryans Buildcon
                  </strong>{" "}
                  has emerged as one of Central India’s most dependable real
                  estate layout developers. We specialize in acquiring
                  high-potential residential land, securing complete government
                  sanctions (NATP & NMRDA), and developing turnkey residential
                  plotted townships.
                </p>
                <p>
                  ...
                  . Every layout is master-planned with wide asphalt roads,
                  sewage networks, electricity, and green recreational parks.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-black/10">
                <div className="flex items-start gap-3 bg-white/60 p-4 rounded-2xl border border-black/5">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] sm:text-[15px] text-grey font-light mt-0.5">
              ...
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-black/10 text-center">
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] sm:text-[13px] pt-2 font-sans text-grey uppercase tracking-wider">
                    Happy Landowners
                  </p>
                </div>
                <div className="space-y-1">
