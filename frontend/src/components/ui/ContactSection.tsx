...
export default function ContactSection() {
  ...
  const validate = (data = formData): FormErrors => {
    ...
    if (!data.emailAddress.trim()) {
      errs.emailAddress =
        "Email address is required to send project layout details.";
    ...
    if (!data.location.trim() || data.location.trim().length < 2) {
      errs.location =
        "Please enter preferred plot area (e.g. Wardha Road, MIHAN).";
    }

    if (!data.narrative.trim() || data.narrative.trim().length < 10) {
      errs.narrative =
        "Please enter project details or questions (at least 10 characters).";
    }
            ...
            >
              <div className="space-y-4">
                ...
                <p className="font-sans text-lg text-ink/70 font-medium max-w-2xl ">
                  ...
                  planning your forever home, we're here to guide you at every
                  stage.
                </p>
              </div>
              ...
              <div className="space-y-6 pt-6 border-t border-black/10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-sans text-xs font-semibold text-gold uppercase tracking-[0.15em] mb-1">
                      Direct Enquiry Email
                    </h4>
                    <a
                      href="mailto:aryansbuildcon@gmail.com"
                      className="font-sans text-[17px] text-ink/70 font-medium duration-300"
                    >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="tel:8767010825"
                      className="font-sans text-[15px] text-ink/70 font-medium duration-300"
                    >
                      +91 8767010825
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[15px] text-ink/70 font-medium">
                      Monday — Sunday, 09:00 — 19:00 IST (Open all 7 days for
                      Site Visits)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-[15px] text-ink/70 font-medium">
                      All layouts are approved by the relevant local authorities
                      (NATP/NMRDA/NIT), with clear and immediate 7/12 land
                      registration.
                    </p>
                  </div>
                </div>
                  ...
                  {!isSubmitted ? (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            handleChange("narrative", e.target.value)
                          }
                    ...
                    >
                      ...
                      <p className="max-w-md mx-auto font-sans text-sm text-grey leading-relaxed font-light">
                        Thank you for choosing Aryans Buildcons. We have
                        received your plot inquiry and site visit booking
                        request. One of our senior Nagpur real estate advisors
                        will call you shortly to arrange a complimentary site
                        visit tour with free transport.
                      </p>
                      <button
